...
"""
params = {'store': None, 'records_per_page': 12, 'page': 1, 'categories': None, 'ordering': None, 'price_promo__gte': None, 'price_promo__lte': None, 'search': None}
...
#with open(result_html_file, encoding='UTF-8') as result_html_file:
...
if __name__ == '__main__':
    ...
    cat_parser = Categories(cat_url, url, save_path_categories)
    cat_parser.run()
